# diel-engine — Backtest Engine (Fase 0)

Jantung "pembuktian" Platform-DIEL: terima **spec strategi (DSL)** + data forex,
keluarkan **metrik + equity curve** yang **deterministik & reproducible**.
...
## Test
```bash
python -m pytest -q     # 17 test: indikator, evaluator, engine e2e, biaya, anti-lookahead
```
